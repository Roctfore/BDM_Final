...
# Load data
supermarket = sc.textFile('/shared/CUSP-GX-6002/FC/hg2683/nyc_supermarkets.csv')
weekly_patterns = sc.textFile('/shared/CUSP-GX-6002/data/weekly-patterns-nyc-2019-2020/*')
nyc_cbg_centroids = sc.textFile('/shared/CUSP-GX-6002/FC/hg2683/nyc_cbg_centroids.csv')
